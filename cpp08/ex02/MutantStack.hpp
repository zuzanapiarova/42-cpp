...
class MutantStack : public std::stack<T, Container>
{
    public:
        ...
        // iterators
        // using typedef because you must tell the compiler that Container::iterator is a type — otherwise, it assumes iterator or const_iterator is just a name referencing a static member or something else
